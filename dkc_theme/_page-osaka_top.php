...
<body>
	<div id="container">
        ...
        ビルズダンスキッズクラブ大阪校</span> </h1>
					<p>随時無料体験レッスン実施中！<br>予約無しでOK!<br class="sp">当日は動きやすい服装と靴をご持参ください</p>
				</section>
				<section class="catch">
					...
					<p><span>大阪、心斎橋、堀江近くのキッズダンススタジオがOPEN!!</span><br>現在は幼児クラスを展開中!!<br>随時無料体験レッスン実施中！<br>
予約無しでOK!<br>
            ...
            ?>">
				...
				<section class="scheduleArea fadein" id="schdule">
					...
					<ul class="scheduleArea__list">
						<li>
							<p class="scheduleArea__list__fig"><img src="<?php echo get_bloginfo("template_directory") ?>/images/osaka/img_aya.png" alt="aya">
							</p>
							<p class="scheduleArea__list__time">毎週木曜日<br>【ドールクラス】16:10~(50分クラス)</p>
						</li>
						<li>
							<p class="scheduleArea__list__fig"><img src="<?php echo get_bloginfo("template_directory") ?>/images/osaka/img_mayu.png" alt="MAYU">
							</p>
              ...
              <span>アールオースタジオ</span></h2>
								...
								<p>アメリカ村内のイキナリステーキ、王将の前にあるmojoという服屋さんのビルの7階</p>
							</div>
						</div>
					</div>
